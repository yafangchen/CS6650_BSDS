...
public class DataProcess {
    ...
    public void statistics(List<Double> list, int maxBucket) {
        ...
        System.out.println("max 256 threads with load balancer");
        System.out.println("=================================");
    ...
    public void plot(int[] counts) throws Exception {
        String plotTitle = "max 256 threads with load balancer";
        String plotImage = "256_lb.png";
